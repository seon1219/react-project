  ...
  return (
    <main>
      <div className="flex items-center justify-center relative z-0">
        ...
        <div className="flex flex-col items-center w-2/5 h-1/2">
          ...
          <div className="border rounded-3xl w-full h-1/2">
            ...
            <div className="flex">
              {projects.map((v, i) => {
                return (
                  <div
                    className="w-64 p-6 bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500"
                    key={i}
                  >
                    <img
